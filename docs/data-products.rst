...
The lower ICs resolutions are generated by running the IC generator again with
a smaller FFT mesh.  The result is equivalent to a sharp k-space filter on the
high-resolution ICs.
